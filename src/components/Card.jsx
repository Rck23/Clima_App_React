...
const Card = ({mostrarData, cargandoData, clima, pronostico}) =>{
    ...
    if(mostrarData){
        ...
        pronosticoFecha3 = pronostico.list[1].dt_txt.substring(8, 10) + '/' + pronostico.list[1].dt_txt.substring(5, 7) + '/' + pronostico.list[1].dt_txt.substring(0, 4) + ' ' +  pronostico.list[1].dt_txt.substring(11, 13);
        pronosticoFecha6 = pronostico.list[2].dt_txt.substring(8, 10) + '/' + pronostico.list[2].dt_txt.substring(5, 7) + '/' + pronostico.list[2].dt_txt.substring(0, 4) + ' ' +  pronostico.list[2].dt_txt.substring(11, 13);
        pronosticoFecha9 = pronostico.list[3].dt_txt.substring(8, 10) + '/' + pronostico.list[3].dt_txt.substring(5, 7) + '/' + pronostico.list[3].dt_txt.substring(0, 4) + ' ' +  pronostico.list[3].dt_txt.substring(11, 13); 
    }
                                    ...
                                    <div className="col-md-8">
                                        ...
                                        <div className="row mt-4">
                                            <div className="col">
                                                ...
                                                <p className="description"><img src={iconoUrl3} alt="icon"/>{pronostico.list[1].weather[0].description}</p>
                                                <p className="temp">{(pronostico.list[1].main.temp - 273.15).toFixed(1)}ºC</p>
                                            </div>
                                            <div className="col">
                                                <p>{pronosticoFecha6}h</p>
                                                <p className="description"><img src={iconoUrl6} alt="icon"/>{pronostico.list[2].weather[0].description}</p>
                                                <p className="temp">{(pronostico.list[2].main.temp - 273.15).toFixed(1)}ºC</p>
                                            </div>
                                            <div className="col">
                                                <p>{pronosticoFecha9}h</p>
                                                <p className="description"><img src={iconoUrl9} alt="icon"/>{pronostico.list[3].weather[0].description}</p>
